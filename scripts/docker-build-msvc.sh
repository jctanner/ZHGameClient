...
while [[ $# -gt 0 ]]; do
	...
	--tests)
		RUN_TESTS="true"
		MAKE_TARGET="${MAKE_TARGET:-z_gameengine_adapter_tests z_gameengine_adapter_macrobuild_tests z_gameengine_adapter_macrobuild_snapshot_tests z_gameengine_adapter_macrobuild_dispatcher_tests z_gameengine_adapter_macrobuild_telemetry_tests z_gameengine_adapter_profilepolicy_tests z_gameengine_adapter_strategicspend_tests z_gameengine_adapter_strategicspend_snapshot_tests z_gameengine_adapter_strategicspend_telemetry_tests z_gameengine_adapter_survivalpolicy_tests z_gameengine_adapter_glausa_strategy_tests z_gameengine_adapter_techmanager_tests z_gameengine_adapter_productionmanager_tests z_gameengine_adapter_zonedefense_tests z_gameengine_adapter_scheduler_tests z_gameengine_adapter_economymanager_tests z_gameengine_adapter_distributedplacement_tests z_gameengine_adapter_capturetask_tests z_gameengine_adapter_combattask_tests}"
		shift
		;;
	--ctest-filter)
		CTEST_FILTER="$2"
